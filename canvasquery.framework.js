...
(function(window, undefined) {
  ...
  eveline = function(events, context, element) {
    ...
    if (typeof tempContext.touchToMouse === "undefined") tempContext.touchToMouse = true;

    if (tempContext.fitToScreen) {
  ...
  eveline.extend(eveline, {
    ...
    onmousemove: function(element, callback, context) {
      ...
      if (MOBILE && context.touchToMouse) return this.ontouchmove(element, callback, context);
    ...
    onmousedown: function(element, callback, context) {
      ...
      if (MOBILE && context.touchToMouse) return this.ontouchstart(element, callback, context);
    ...
    onmouseup: function(element, callback, context) {
      ...
      if (MOBILE && context.touchToMouse) return this.ontouchend(element, callback, context);
